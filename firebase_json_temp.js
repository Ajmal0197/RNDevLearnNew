const config = {
  'react-native': {
    ...
    crashlytics_ndk_enabled: false, // Set to true in production
    crashlytics_auto_collection_enabled: true, // Set true in production
    crashlytics_is_error_generation_on_js_crash_enabled: false, // Set to true in production
